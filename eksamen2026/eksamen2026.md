Nedenfor ses eksamensprojektoplæg og generel eksamensinformation for skoleåret 2025/2026.   
God fornøjelse ;-) :
...
## Fredag d.27/2 kl.23:00 : Projektbeskrivelse og GDD på lectio
...
## Tirsdag d.5/5 kl.22:00 : Pdf-fil på lectio + link til produkt eller eksekverbart produkt

Opgaven indeholder ca. 90 lektioner på skolen og 50 timers elevtid. Dvs. det samlede omfang af projektet er ca. 140 timer.         
...
## Onsdag d.6/5 kl.13:00 senest : Papir-version til administrationen  
...
- [Emne 5: økonomi](emner/emne5_penge.md)
...
# Projektbeskrivelsen, Game design document og tekniske problemstillinger
...
Husk at I skal vælge en række [tekniske problemstillinger](https://ddu.systime.dk/?id=224#c359) som skrives ind i projektbeskrivelsen.    
...
Vi forventer et højt niveau indenfor både valg og udførsel af projektstyring igennem hele projektet, herunder en særlig kritisk indstilling til tidshorisonter (for optimistiske / pessimistiske) og projektomfang hvilket løbende bør revurderes efter hver iteration.  

Der skal udvikles en prototype. Prototypen skal testes af på målgruppen og danne grundlag for den endelige udvikling af produktet.  
...
- Digital aflevering på lectio 
  ...
  *1) Evt. udfordringer der måtte vise sig ift. brug af database sammen med eksekverbar fil vil vi løse rent praktisk hen af vejen.
